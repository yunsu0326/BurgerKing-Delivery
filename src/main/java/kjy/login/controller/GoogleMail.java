...
public class GoogleMail {
   ...
   public void send_certification_code(String recipient, String certification_code) throws Exception { 
      ...
      // 1. 정보를 담기 위한 객체
        ...
        // 제목 설정
        String subject = "세미프로젝트 버거킹 홈페이지에서 회원님의 비밀번호를 찾기 위한 인증코드 발송";
   ...
   public void sendmail_OrderFinish(String recipient, String name, String emailContents) throws Exception {
      ...
      // 1. 정보를 담기 위한 객체
        ...
        // 제목 설정
        String subject = "세미프로젝트 버거킹 홈페이지에서의 "+name+"님의 주문이 성공했습니다. ";
        msg.setSubject(subject);
        ...
        // 메시지 본문의 내용과 형식, 캐릭터 셋 설정
        msg.setContent(emailContents+"</div>", "text/html;charset=UTF-8");
